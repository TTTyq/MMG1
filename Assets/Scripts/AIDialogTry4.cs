...
public class AIDialogTry4 : MonoBehaviour
{
    ...
    void AddMessage(string message)
    {
        ...
        //if (customFont != null)
        //{
            //messageLabel.style.unityFont = customFont; // 使用自定义字体
            //messageLabel.style.fontSize = 20;         // 可选：设置字体大小
            //messageLabel.style.color = new StyleColor(Color.grey); // 可选：设置字体颜色
       // }
